            ...
            <table>
                ...
                <c:forEach items="${ sessionScope.projets }" var="mapProjets" varStatus="boucle">
                    ...
                    <tr class="${boucle.index % 2 == 0 ? 'pair' : 'impair'}">
                        ...
                        <td><c:out value="${ mapClients.value.numero_projet }"></c:out></td>
                        <td><c:out value="${ mapClients.value.avancement }"></c:out></td>
                        <td><c:out value="${ mapClients.value.date_creation }"></c:out></td>
                        <td><c:out value="${ mapClients.value.modalite_paiement }"></c:out></td>
                        <td><c:out value="${ mapClients.value.date_debut_prestation }"></c:out></td>
                        <td><c:out value="${ mapClients.value.date_fin_prestation }"></c:out></td>
                        <td><c:out value="${ mapClients.value.adresse }"></c:out></td>
                        <td><c:out value="${ mapClients.value.commercial.nom }"></c:out></td>
