...
public final class CreationProjetForm {
    ...
    private void validationDateFin(String dateFin) throws FormValidationException {
        if ( dateFin != null ) {
    ...
    private void validationDateDebut(String dateDebut) throws FormValidationException {
        if ( dateDebut != null ) {
